...
const page = () => {
  return (
    <div className="w-full h-full ">
      <div className="halfPageSection flex  justify-center items-center border-soild border-blue-700 lg:flex-row lg:min-h-screen space-y-10 lg:space-y-0">
        <div className="lg:basis-3/5 flex-center-both pb-nav-margin">
          <div className="w-4/5 h-4/5 flex justify-center lg:px-10 flex-col  space-y-12">
              ...
              <form encType="multipart/form-data">
                <div className="space-y-6">
                  ...
                  <div className="flex">
                    <button
                      type="submit"
                      className="  border-2 smooth  px-20 py-3 bg-blue-500 border-blue-500 dark:bg-blue-600 dark:border-blue-600 hover:bg-opacity-0 dark:hover:bg-opacity-0 dark:bg-opacity-100 bg-opacity-100 hover:text-blue-500 dark:hover:text-blue-600 clr-white rounded-md "
                    >
                      تسجيل الدخول
                    </button>
                  </div>
